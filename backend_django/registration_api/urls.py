...
urlpatterns = [
    ...
    path(
        'siswa/subjects/',
        views.SiswaMateriListView.as_view(),
        name='siswa-subject-list'
    ),
    path(
        'siswa/tasks/',
    ...
    path(
        'siswa/ujian-cbt/',
        views.SiswaUjianCBTListView.as_view(),
        name='siswa-ujian-cbt-list'
    ),
    path(
        'siswa/ujian-cbt/<uuid:pk>/mulai/',
        views.SiswaUjianCBTMulaiView.as_view(),
        name='siswa-ujian-cbt-mulai'
    ),
    path(
        'siswa/ujian-cbt/<uuid:pk>/submit/',
        views.SiswaUjianCBTSubmitView.as_view(),
        name='siswa-ujian-cbt-submit'
    ),
    ...
    path(
        'guru/agenda-wajib/<uuid:pk>/students/',
        views.GuruAgendaWajibStudentsView.as_view(),
        name='guru-agenda-wajib-students'
    ),
    path(
        'guru/agenda-wajib/<uuid:pk>/attendance/',
        views.GuruAgendaWajibAttendanceView.as_view(),
        name='guru-agenda-wajib-attendance'
    ),

    path(
        'guru/pengajuan-izin/',
        views.GuruPengajuanIzinListView.as_view(),
        name='guru-pengajuan-izin-list'
    ),
    path(
        'guru/pengajuan-izin/<uuid:pk>/verify/',
        views.GuruPengajuanIzinVerifyView.as_view(),
        name='guru-pengajuan-izin-verify'
    ),

    # Guru SKK Siswa
    path(
        'guru/skk/student-competencies/',
        views.GuruStudentCompetencyListView.as_view(),
        name='guru-student-competency-list'
    ),
    path(
        'guru/skk/student-competencies/<uuid:pk>/',
        views.GuruStudentCompetencyUpdateView.as_view(),
        name='guru-student-competency-update'
    ),
