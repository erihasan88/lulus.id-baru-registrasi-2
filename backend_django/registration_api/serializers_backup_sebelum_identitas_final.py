from .models import StudentGrade, StudentBill, PaymentSetting, PaymentMethodSetting, ManualPaymentSetting, Competency, StudentCompetency, CapaianPembelajaran, ChatConversation, ChatParticipant, ChatMessage, IdentitasLembaga
from .models import AcademicTranscript
from rest_framework import serializers
from django.contrib.auth import get_user_model
from .models import StudentRegistration, PaymentInvoice, RejectionLog, AcademicYear, Teacher, Fase, MataPelajaran, Rombel, ProgramBelajar, BebanBelajar, Announcement
...
class IdentitasLembagaSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'logo_pkbm',
            'logo_yayasan',
            'qr_tanda_tangan_kepala_sekolah',
            'cap_stempel_digital',
