            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 bg-pink-600 hover:bg-pink-700 disabled:bg-slate-800 disabled:text-slate-500 text-white rounded-xl text-xs font-black shadow-lg shadow-pink-600/15 transition-all cursor-pointer disabled:cursor-not-allowed"
                >
